...
# creating users
User.create(first_name: "Jack", last_name: "Pepper")
User.create(first_name: "Princess", last_name: "Mulan")
User.create(first_name: "Captain", last_name: "Sparrow")
User.create(first_name: "Tony", last_name: "Tiger")
User.create(first_name: "Mary", last_name: "Jane")
