...
dojo = Dojo.new(name: "CodingDojo DC", city: "DC")
dojo.save
...
Dojo.first.ninjas.create(first_name: "Jack", last_name: "Pepper")
Dojo.first.ninjas.create(first_name: "Jill", last_name: "Bean")
Dojo.first.ninjas.create(first_name: "Harry", last_name: "Potter")
...
Dojo.second.ninjas.create(first_name: "Donald", last_name: "Duck")

# 6.6 Create 3 more ninjas and have them belong to the second dojo you created.
Dojo.third.ninjas.create(first_name: "Doctor", last_name: "Who")
Dojo.third.ninjas.create(first_name: "Sherlock", last_name: "Holmes")
Dojo.third.ninjas.create(first_name: "Dexter", last_name: "Show")
